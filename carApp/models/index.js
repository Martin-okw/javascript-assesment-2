...
pool.query(
  `CREATE TABLE IF NOT EXISTS BlackforceprojectMartinokwuegbe(
  ...
  (err, res) => {
    if (err) {
      ...
      console.log("BlackforceprojectMartinokwuegbe Table Created Successfully"); // replace Sahmie with your name
      // console.log(res);
    }
  }
);
